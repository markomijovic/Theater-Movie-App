...
public class BrowseShowtimePage extends Page {
	...
	public BrowseShowtimePage() {
		this.setSize(470, 400);
        this.setLocation(300, 300);
        this.setResizable(false);
        this.setLayout(null);
        JLabel title = new JLabel("Browse Showtimes Page");
        title.setBounds(130, 15, 570, 30);
        title.setFont(new Font("Ariel", Font.BOLD, 20));
        this.add(title);

        JLabel selectionPromptLabel = new JLabel("Showtime Id: ");
        ...
        refineBrowseButton = new JButton("Browse Seats");
	...
	public void addButtonActionListener(ActionListener HomepageListener, ActionListener SelectShowtimeListener) {
